<?php
ob_start();
define('API_KEY','957919807:AAFQ2cR3mot036qD_4Tr__iHXed90wJyJiM';)
$admin = "831477295"; //admin id
$bot = "USAnombersBOT"; //bot ismi
$kanalimz = "@XABARCHILAR"; //kanal useri
/// @XABARCHILAR kanaliga obuna bo'ling///
   function del($nomi){
...
ILTIMOS QILARDIKKI OZROQ SABRLI BO‘LING
ETIROZLAR BO‘LSA👇
CREATOR GA YOZING",
        'reply_to_message_id'=>$mid,
        'reply_markup'=>$key3,
        ...
        bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"@HAMMAGAYORDAMBERAMAN! ga yozing
⛔Spam boʻlsangiz: @sevgi_tanishuvlar_olami  ga yozing!",
        'reply_to_message_id'=>$mid,
        ]);
        $ball -=10;
...
♻YANGILANMOQDA(online)
BOT YASAB BERAMIZ: @DASTURCHI_YIGIT",
      'reply_to_message_id'=>$mid,
      'reply_markup'=>$key,
      ]);
    }
    ...
    if($tx == "👨🏻‍💻Admin Bilan Bogʻlanish👨🏻‍�?"){
      ...
      bot('sendMessage',[
      'chat_id'=>$cid,
'text'=>"Admin: @HAMMAGAYORDAMBERAMAN
 🕗Ish Vaqti: 24 soat
Bot yaratishni istasangiz: @DASTURCHI_YIGIT
⛔Spamlar: @sevgi_tanishuvlar_olami ";
      'reply_to_message_id'=>$mid,
      'reply_markup'=>$key,
      ]);
    }
...
5 kun ichida kanaldan chiqib ketsangiz sizning 8 balingiz olib qoʻyiladi.";
...
$kabi = $kabin + 5;
    ...
    if(isset($tx)){
      ...
      foreach($faylla as $fayl){
        ...
        bot('sendMessage',[
        'chat_id'=>$usri,
        'text'=>"Siz $chati kanalidan 5 kun boʻlmasidan chiqib ketdingiz.Sizdan 8 bal ayirilmoqda... ",
        'reply_markup'=>$key,
        ]);
        /// @XABARCHILAR kanaliga obuna bo'ling///
