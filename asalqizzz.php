...
error_reporting(0);
ob_start();
define('API_KEY', '1028270205:AAH8F-Hqwy77XM74SY9vudxLPXy_vWgtOR4');
$admin = "831477295"; 
$kanali = "@XABARCHILAR";
...
[ 'inline_keyboard'=>[
                ...
                [['text'=>'✅Botga Kirish','url'=>'https://telegram.me/Asal_qizcha_bot'],], 
               ] ],
...
if($get =="member"){
  ...
  bot('sendmessage', [
   ...
   if($data == "reklamaqilish"){
      ...
      $in = "🕵*Do'stlaringizni taklif qilish uchun ssilka:*➡️ [https://telegram.me/Asal_qizcha_bot?start=$chat_id2]

_👤Har bitta taklif qilingan va bu botdan oldin foydalanmagan odamga 50 ochko olasiz!
...
if($text1 == "/start" or $text1 == "/start@Asal_qizcha_bot"){
...
$usr = $usr + 50; 
      ...
      bot('sendMessage',[
      'chat_id'=>$refid,
'text'=>"Достигизни таклиф килганиз учун 50 очко берилди 👏🏻
...
'caption'=>"Biz bilan birga boling doyimo hizmatizdamiz 😉 Albatta @Soataliyev_No1", 
]);  
$chm = file_get_contents("news.txt");
bot('forwardMessage', [
'chat_id'=>$chat_id,
...
'disable_web_page_preview'=>true,
  ...
  [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Asal_qizcha_bot?startgroup=new']]
]   
]),
]);
}
...
if(mb_stripos($data,"🎓Yoshi:")!==false){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
'text'=> "⚜*Salom $name
Mening ismim diana dugonalarim esa diana deb chaqirishadi!\n\n❤ Men guruhlarda gaplasha olaman va  guruh adminlari uchun qulay bo‘lgan  buyruqlar orqali guruhni boshqarishga ko‘maklashaman!*\n
📃*Men xuddi insonga o'xshayman guruhga qo'shsangiz ko'plab so'zlar yodlayman yana odam deb o'ylamang!*\n
*🆔Men yana inline rejimda kanal va gruppa haqida ma'lumot ham beraman sinab ko'rish tugmasi orqali tekshirib ko'rishingiz mumkin*\n\n❤*Admin xaqida:* @DASTURCHI_YIGIT
💰*Pul Ishlash:* @Qulaypaynetbot
😈*Yaratuvchi:* @DASTURCHI_YIGIT",
...
['inline_keyboard' => [
  ...
  [['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Asal_qizcha_bot?startgroup=new']]
]
]),
]);
}
...
[['text'=>'🔙Orqaga ','callback_data'=>"back"],['text'=>'❤Tarqatish❤','url'=>'http://telegram.me/share/url?url=https://t.me/Asal_qizcha_bot']]
]
]),
]);
}
...
[['text'=>'⛅Termiz☁','callback_data'=>"ter"],['text'=>'📡DASTURCHI_YIGIT Blogger','url'=>'https://telegram.me/DASTURCHI_YIGIT']],
[['text'=>'🔙Orqaga','callback_data'=>"foydali"],['text'=>'❤Tarqatish❤','url'=>'http://telegram.me/share/url?url=https://t.me/Asal_qizcha_bot']]
]
]),
]);
}
...
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
[['text'=>'📋Qollanma','url'=>'https://telegra.ph/Valijonbot-haqida-03-02'],],
...
[['url' => 'https://telegram.me/Asal_qizcha_bot?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
]
]),
]);
}
...
if($data=="a"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "👮*Bot admini va reklama bo'yicha:* [DASTURCHI_YIGIT](https://t.me/aloqa0221bot)
💰*Telegramda ishlash:* [Qulaypaynetbot](https://t.me/Qulaypaynetbot)

☎️ *Telefon:* +998 934600221\n\n
⏳ *Ish Vaqti:* 13:00 - 23:00\n\n
*Bot yasattirish uchun* [🔏DASTURCHI_YIGIT](https://t.me/DASTURCHI_YIGIT) *bilan narxlarni kelishib oling*",
    'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
 [['text'=>'👨‍💻 Admin','url'=>'https://telegram.me/DASTURCHI_YIGIT'],], 
 [['text'=>'🚫 Spamlar Uchun','url'=>'https://telegram.me/aloqa0221bot'],], 
[['text'=>'🔙Orqaga', 'callback_data' => "back"]],
[['url' => 'https://telegram.me/Asal_qizcha_bot?startgroup=new', 'text' => "👥Guruhga Qo‘shish"],],
]
]),
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'📬Buyurtma berish♻','url'=>"https://t.me/DASTURCHI_YIGIT"],], 
...
if($data=="botlarimiz"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "*Salom, biz yaratgan botlarimiz bilan tanishib chiqing. Sizlarga ham botlar kerak bo‘lsa, bizga murojaat qiling!*\n*Jamoamiz:* [@XABARCHILAR]",
'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'Logotif','url'=>'https://telegram.me/referalbot'],],
   [['text'=>'💝Adminka','url'=>'https://telegram.me/guruhpluskanalbot'],], 
    [['text'=>'Ulashishbot','url'=>'https://telegram.me/xabarchilar'],], 
...
if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@Asal_qizcha_bot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
'chat_id'=>$chat_id, 
'reply_to_message_id'=>$mid,
'photo'=>"http://www.iloveheartstudio.com/-/p.php?t=$ex[1]%EE%BB%AE$ex[2]%20$ex[3]%0A$ex[4]%0D%0ABy%20%20@XABARCHILAR&bc=000000&tc=ffffff&hc=FF0000&f=n&uc=true&ts=true&ff=PNG&w=500&ps=sq",
'caption'=>"by @XABARCHILAR",
]);
}

$id = $update->message->from->id;
$get = file_get_contents("https://api.telegram.org/bot781536721:AAHu0R6y3hVZM3r5xm4ilkDTWk-w-uKuE7o/getUserProfileNick?user_id=$id&limit=99");
$json = json_decode($get);
$photo = $json->result->photos[0][0]->file_id;

if(mb_stripos($mtext,"/rasm" or $mtext,"/rasm2@Asal_qizcha_bot") !== false){ 
  bot('sendPhoto',[
       'chat_id'=>$chat_id,
        'photo'=>$photo,
        'parse_mode'=>'markdown',
...
👮<b>Bot admini:</b> <a href='tg://user?id=342656235'>DASTURCHI_YIGIT</a>", 
      ]);
   }
...
/// YANGI KOD
if($text1 == "/sozlamalar" or $text1 == "/sozlamalar@Asal_qizcha_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
🌠Bu oy $buoy kundan iborat",
    ...
    if($text1 == "/admin" or $text == "/admin@Asal_qizcha_bot"){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
...
if((stripos($mtext,"DASTURCHI_YIGIT") !== false) or (stripos($mtext,"DASTURCHI_YIGIT")!==false) or (stripos($mtext,"DASTURCHI_YIGIT")!==false)){
  $name = $message->from->first_name;
...
if((stripos($mtext,"Oltinvodiy") !== false) or (stripos($mtext,"izminka")!==false) or (stripos($mtext,"yagona")!==false)){
  $name = $message->from->first_name;
  $input = array("😉Ha oltinvodiyda dam ogiz keldimi yuring menam birga boraman","😑Hozi izminka sovuq nimaga gapirdiz","👍yagona meni yaratuvchimni shaxsiy bari boringlar zur joy");
  $rand=rand(0,2);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
if((stripos($mtext,"oqoltin")!==false)){
$input = array("Voy,men ham oqoltinlik","Hamqishloq ekanmiz☺","Men ham sardobadanman😊","Qayeridan?","Bitta joydan ekanmiz");
  $rand=rand(0,4);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
$input = array("Ha","Ha shunaqa","Hm shunday","Haye.","Ha rost");
 ...
 if($fadmin==$admin){
    bot('sendmessage',[
      'chat_id'=>$chat_id,
      'text'=>"😉Assalomu alaykum begim gruppa tinch",
      ]);
  }else{
  $name = $message->from->first_name;
  $input = array("Assalom","Salom $name ,guruhimiz sizga yoqtimi?","Salom, ismiz nima?","Assaalomu alaykum","Привет, как дело?","Qaleysiz?","Sizga ham salom","Salom.", "Salom qaleysiz?","Vaalaykum salom,baxtli bo‘ling😊.","Yaxshimisiz $name,namuncha ko‘rinmay ketdiz?", "Juda sersalom ekansiz☺", "Assalomu aleykum.", "Salom $name.", "Iye keling,endi sizni eslab turgandik","Ana,yana bitta kampot keldi😂","Salom meni tanidizmi?","Salom bergan kishini...Xudo o‘nglar ishini.","Namuncha salom beruras","Salomim so‘lim-so‘lim  kitobdadur o‘ng  qo‘lim.Tringlab hech qoymagan telegramda chap qo‘lim🤣🤣🤣","Sizni ko‘radigan kun ham  bor ekanu!","Salom,yaxshimisiz?","Qaleysiz?","Asssalomu alekooom begim😉 Ishlar qaley?","Sava","Привет ","Hello $name,qaleysiz?","Salom.Nik daxshatu a?","Ehe keb qoling, anu gap nima bo'ldi?","Yuragizni sevgi muhabbat qoplagan vaqda to‘g‘ri shu yerga kelevering,ok?","Garov  o‘ynaymizmi  kimnidur sevib qolgansiz?Agar adashayotgan bo‘lsam,garov haqida unuting😆","Bolla, qizla bitta fikr bor!","Keling,sizni ham ko‘radigan  kun  bor ekanu");
  $rand=rand(0,32);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'chat_id'=>$chat_id,
...
if(stripos($mtext,"kimni") !== false){
  $input  = array("Bilmasam?","katta holangni😂","Bugun havo zoru a?","Men bilmayman");
  $rand=rand(0,3);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
    'chat_id'=>$chat_id,
...
if(stripos($mtext,"kimsan")!== false){
  $name = $message->from->first_name;
  $input = array("N1","Shu savolni eshitsam negadur nikimga hech nima yozilmagan ekan degan hayolga boraman!?.","Hazilkash robotcha!","kim deb o‘ylaysiz?","Traktorchi Abdusatorni qo‘shinisi Sobirni amakivachasiga boja bo‘lgan G‘anisher degan aka boru, o‘sha moshiniga tonirofka qildiribdi😜","Kapitan Telegram","Qitmirman, yana Miki bilan adashtirib yubormeng😂","Sirliman🎩","O‘ziz kimsiz?","Har doim shu savolni  beruvirib charchamadizmi?","Tinchlikmi kimligim bilan qiziqib qolibsiz!?","Menmi?","Nima edi😡...Vux qo‘rqib ketdiza?","Selena gomes😉,","Gruppani adminkasiman!");
  $rand=rand(0,13);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
if((stripos($mtext,"Status")!==false) or (stripos($mtext,"status")!== false)){
  $input = array("😐Voy status esdan chiqti","Yaxshi status yupkaga oxshashi kere etiborni tortadigan darajada kaltaligi bilan @DASTURCHI_YIGIT","Bu dunyoda dardingni hatto qalamga ham aytma srazi borib qogozga sotadi @DASTURCHI_YIGIT","Qiziq a... 
Inson yerga yiqilsa kulamiz
Iphone yerga tushib ketsa achinamiz. @DASTURCHI_YIGIT","Kimdur manda qalesan ?
Axvollaring qale ?
Ishlaring joyidami ?
deb so'rashsa yuzimda tabassum bilan
Hammasi yaxshi hammasi joyida
deb javob beraman
Lekin kimdur kozlarimga qarab togrisini ayt deyishini xolardim @DASTURCHI_YIGIT","Yurak suyaksiz ammo eng kop sinadigan ham YURAKDIR @DASTURCHI_YIGIT","Dunyoda aytish qiyin bolgan eng uzun va qiyin beshta soz bor. Mana ular : 
1.Sinxrofazotron. 
2.Fenolftalein.
3.Dixlordifeniltrixloretan.
4.Tetragidrokannabinol. 
5. Eng qiyini va kopchilik talafuz qila olmaydigon soz bu KECHIRING @DASTURCHI_YIGIT","Dunyoda achchiq bomasa shirinni qadri yoq! @DASTURCHI_YIGIT","ALLOH AYTADI
Agar bandam menga bir qadam yursa men ikki qadam yuraman, Agar bandam mega qarab yurib kelsa men yugurib boraman. @DASTURCHI_YIGIT","AyriM InsonlanI YaqindaN BilganiM SarI ItlagA BogaN MexriM OshvottI @DASTURCHI_YIGIT","FuUuUu blin 
Ishi tushsa  typing
Ishi tushmasa online @DASTURCHI_YIGIT","Hayot yurak chizmasiga o'xshaydi, Agar bir tekkis chiziqaa aylansa bu sening o'lganingni anglatadi !!!...... @DASTURCHI_YIGIT","Osmon musaffoligiga sabab u yerda odamlar yashamaydi... @DASTURCHI_YIGIT","Qanotlaringga kuch yig'may turib Xayotda baland parvoz qilma! Chunki balanddan sho'ng'ishning oqibati ayanchli.. @DASTURCHI_YIGIT","Haqiqiy yigit sevgani haqida boshqalarga so'zlab bermaydi. @DASTURCHI_YIGIT");
  $rand=rand(0,30);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
🔅<b>Usernamesi:</b> @$username ", null, false
   ...
   if((mb_stripos($mtext,"#DASTURCHI_YIGIT") !== false)){ 
bot('SendMessage',[
'chat_id'=>$chat_id,
'reply_to_message_id'=>$mid,
...
if((mb_stripos($mtext,"#DASTURCHI_YIGIT") !== false) or (mb_stripos($mtext,"/DASTURCHI_YIGIT")!==false)){
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
if($text1 == "ro" or $text1 == "Ro" or $text1 == "RO" or $text1 == "/ro@Asal_qizcha_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage', [
    ...
    if($text1 == "Kick"  or  $text1 == "kick"  or $text1 == "/kick" or $text1 == "/kick@Asal_qizcha_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="member"){
 ...
 if($text1 == "Addpm" or $text1 == "addpm" or $text1 == "/addpm@Asal_qizcha_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage',[
   ...
   if($text1 == "Delpm" or $text1 == "delpm" or $text1 == "/delpm@Asal_qizcha_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('promoteChatMember',[
  ...
  if($text1 == "Unro" or $text1 == "UNRO" or $text1 == "unro" or $text1 == "/unro@Asal_qizcha_bot"){
 $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 == "pin" or $text1 == "Pin" or $text1 == "/pin" or $text1 == "/pin@Asal_qizcha_bot" or $text1 == "piN" or $text1 == "pIN" or $text1 == "pIn" or $text1 == "pIN"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if((stripos($mtext,"Sw")!==false) and $fadmin == $admin){
 ...
 if($text1 == "Del" or $text1 == "/del" or $text1== "del" or  $text1 == "/del@Asal_qizcha_bot"){
   bot('deleteMessage', [
    'chat_id'=>$chat_id,
    'message_id'=>$mesid
  ]);
 ...
 if($text1 == "ban" or $text1 == "Ban" or $text1== "/ban@Asal_qizcha_bot" or  $text1 == "/ban"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
 ...
 if($text1 == "Unban" or $text1 == "/unban" or $text1== "/unban@Asal_qizcha_bot" or  $text1 == "unban"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
 ...
 if($text1 == "Warn" or $text1 == "warn" or $text1== "/warn@Asal_qizcha_bot" or  $text1 == "/warn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
 ...
 if($text1 == "Unwarn" or $text1 == "unwarn" or $text1== "/unwarn@Asal_qizcha_bot" or  $text1 == "/unwarn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
